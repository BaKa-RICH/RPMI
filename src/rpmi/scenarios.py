...
def readiness_report_to_row(
    ...
    *,
    ...
    metrics = report.metrics
    row = {
        "batch_id": (log_context or {}).get("batch_id", ""),
        "unique_run_id": (log_context or {}).get("unique_run_id", (log_context or {}).get("run_id", "")),
        "config_hash": (log_context or {}).get("config_hash", ""),
        "code_version": (log_context or {}).get("code_version", ""),
        "metrics_schema_version": (log_context or {}).get("metrics_schema_version", "metrics_v2.1"),
        "readiness_schema_version": (log_context or {}).get("readiness_schema_version", "readiness_v2.1"),
        "evidence_package_version": (log_context or {}).get("evidence_package_version", "wave_6A0_v2.1"),
        ...
        "raw_time_expanded_slot_count": metrics.get("raw_time_expanded_slot_count", 0),
        "D_H": metrics.get("D_H", 0.0),
        "S_R_0": metrics.get("S_R_0", 0.0),
        "Z_R_0": metrics.get("Z_R_0", 0.0),
        "reservable_edge_count": metrics.get("reservable_edge_count", 0),
        "matched_edge_count": metrics.get("matched_edge_count", 0),
        "total_edge_count": metrics.get("total_edge_count", 0),
        "near_miss_edge_count": metrics.get("near_miss_edge_count", 0),
        "boundary_CAV_HDV": metrics.get("boundary_CAV_HDV", 0),
        "boundary_HDV_CAV": metrics.get("boundary_HDV_CAV", 0),
        "boundary_CAV_CAV": metrics.get("boundary_CAV_CAV", 0),
        "boundary_HDV_HDV": metrics.get("boundary_HDV_HDV", 0),
        "boundary_cav_available_count": metrics.get("boundary_cav_available_count", 0),
        "inner_receiving_gap_count": metrics.get("inner_receiving_gap_count", 0),
        "raw_gap_illusion_count": metrics.get("raw_gap_illusion_count", 0),
        "dominant_invalid_reasons": metrics.get("dominant_invalid_reasons", {}),
        "readiness_fail_reasons": [] if report.readiness_pass else report.fail_reason.split(";"),
